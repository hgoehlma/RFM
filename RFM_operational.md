...
`v0.16.0` // `top_level_operational` // [living]
...
- Reasoning stated at a level of generality that would be true of any project in any domain, particularly in Hard Lessons and Chosen Direction sections
