...
You are performing an operational sweep. This is a deliberate corrective pass, not ambient discipline. Concentrated relational checking is required. Do not summarize either document. Do not make edits. Produce findings for human ruling.
...
Do not introduce structural-sweep or language-sweep content into operational findings. The test is whether the cognitive mode that generated the question is relational boundary-checking. A question generated by architectural judgment or by close reading does not belong here, even if it also identifies a boundary problem.

---

*operational sweep prompt // [living]*
