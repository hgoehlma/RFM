...
`v0.6.1` // `top_level_artifact` // [living]
...
|---|---|---|---|
| `RFM_top_level_reasoning.md` | `top_level_reasoning` | v0.16.0 | The problem, assumptions, landscape, chosen direction, boundaries, open questions and hard lessons governing the methodology as a whole |
...
| `RFM_glossary.md` | `top_level_artifact` | v0.2.0 | Disambiguation of terms that carry different meanings across reader contexts |
...
| `RFM_instruction_design_reasoning.md` | `module_reasoning` | v0.6.0 | The reasoning document governing how an instruction is shaped, where it is placed, and whether anything checks it |
