...
`v0.11.4` // `top_level_artifact` // [living]
...
| `RFM_glossary.md` | `top_level_artifact` | v0.5.0 | travels | Disambiguation of terms that carry different meanings across reader contexts |
...
| `RFM_skill_drafting_operational.md` | `skill_operational` | v0.8.0 | stays | Derivation procedure, pre-check specification, and skill body maintenance for the rfm-drafting skill |
