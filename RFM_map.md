...
| `RFM_traveling_prompt_reasoning.md` | `module_reasoning` | v0.3.0 | stays | The reasoning document governing traveling prompt design decisions |
...
| `RFM_sweep_reasoning.md` | `module_reasoning` | v0.8.0 | stays | The reasoning document governing sweep prompt design decisions |
