...
| `RFM_traveling_prompt_reasoning.md` | `module_reasoning` | v0.5.0 | stays | The reasoning document governing traveling prompt design decisions |
...
| `RFM_human_prompt_reasoning.md` | `module_reasoning` | v0.3.2 | stays | Reasoning document governing human prompt design decisions |
...
| `RFM_derivation_prompt_reasoning.md` | `module_reasoning` | v0.6.1 | stays | The reasoning document governing derivation prompt design decisions |
