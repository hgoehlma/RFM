...
`v0.11.7` // `top_level_artifact` // [living]
...
| `RFM_traveling_prompt_reasoning.md` | `module_reasoning` | v0.4.0 | stays | The reasoning document governing traveling prompt design decisions |
...
| `RFM_sweep_reasoning.md` | `module_reasoning` | v0.9.0 | stays | The reasoning document governing sweep prompt design decisions |
...
| `RFM_human_prompt_reasoning.md` | `module_reasoning` | v0.3.1 | stays | Reasoning document governing human prompt design decisions |
...
| `RFM_guided_drafting_prompt_reasoning.md` | `module_reasoning` | v0.2.0 | stays | Reasoning document governing guided drafting prompt design decisions |
...
| `RFM_derivation_prompt_reasoning.md` | `module_reasoning` | v0.6.0 | stays | The reasoning document governing derivation prompt design decisions |
