...
| `RFM_skill_unslop_operational.md` | Skill operational | v0.3.0 | Derivation procedure, traveling prompt declaration, and pattern list maintenance for the rfm-unslop skill |
...
| `RFM_skill_rfm_ripple_check_operational.md` | Skill operational | v0.3.0 | Derivation procedure and retirement steps for the rfm-ripple-check skill |
...
| `RFM_skill_rfm_drafting_operational.md` | Skill operational | v0.5.0 | Derivation procedure, pre-check specification, and skill body maintenance for the rfm-drafting skill |
