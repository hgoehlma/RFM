...
`v0.11.5` // `top_level_artifact` // [living]
...
| `RFM_instruction_design_reasoning.md` | `module_reasoning` | v0.19.0 | stays | The reasoning document governing how an instruction is shaped, where it is placed, and whether anything checks it |
